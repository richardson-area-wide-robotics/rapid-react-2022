...
public class Intake extends SubsystemBase {
  ...
  private static final double kPArm = 0.0;
  private static final double kIArm = 0.0;
  private static final double kDArm = 0.0;
  private static final double kIzArm = 0.0;
  private static final double kFFArm = 0.0;
  private static final double kMaxOutputArm = 0.0;
  private static final double kMinOutputArm = 0.0;
  ...
  public Intake() {
    ...
    rightArmMotor
        .getEncoder()
        .setPositionConversionFactor(Constants.ARM_POSITION_CONVERISON_FACTOR);
  ...
  /**
   * @param intakePower between -1 and 1 sends intakePower to intakeMotor positive power --> intake
